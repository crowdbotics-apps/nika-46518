"""
Django settings for nika_46518 project.
...
WSGI_APPLICATION = 'nika_46518.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nika_46518 API",
    "DESCRIPTION": "API documentation for nika_46518 App",
    "VERSION": "v1",
}
